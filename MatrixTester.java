...
public class MatrixTester {
		...
		{			
			...
			Matrix computedTranspose = M1.transpose();
			System.out.println("Computed result for transposition:\n" + computedTranspose);
			
			boolean computedEquals = M1.equals(M1);
			System.out.println("Computed result for ComputeEquals:\n" + computedEquals);
